<template>
    <section class="section">
        ...
        <h2>Анкета заключения договора для ИП</h2>
        <b-form class="mt-4" @submit.prevent="submitHandler">
            ...
            >
                <b-form-input
                    ...
                    :state="$v.form.cheque.$dirty ? !$v.form.cheque.$invalid : null"
                ></b-form-input>
                <b-form-invalid-feedback v-if="!$v.form.cheque.required">Это поле не должно быть пустым</b-form-invalid-feedback>
                <b-form-invalid-feedback v-if="!$v.form.cheque.numeric && $v.form.cheque.required">Должны быть только цифры</b-form-invalid-feedback>
            </b-form-group>
            <b-form-group
